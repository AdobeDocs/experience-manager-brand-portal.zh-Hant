...
* **在Experience Manager作者執行個體上設定Dynamic Media雲端服務**
  ...
  根據Experience Manager Author執行所在的Dynamic Media模式（Scene7模式或混合模式），從[Tools[!DNL Scene7]在Experience Manager Author上設定](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dms7#configuring-dynamic-media-cloud-services)Dynamic Media雲端服務（[模式）](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/config-dms7#configuring-dynamic-media-cloud-services)或&#x200B;**Dynamic Media雲端服務（混合模式）** | **雲端服務** | **動態媒體**。
